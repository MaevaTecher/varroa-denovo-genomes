...
The following table list all *40 genes under positive selection* shared only by both Varroa mite genomes. Possible genes implicated in tolerance to external stressors or stimuli (Table 2) is indicated in black.
